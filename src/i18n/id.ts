const id = {
    ...
    characacters: {
        ...
        openness: {
            ...
            keyCharacteristics: ["Imajinatif", "artistik", "reflektif", "penasaran", "abstrak", "fleksibel"],
            strength: [
                "Kreatif",
                "Open-minded",
                "Visioner",
            ...
            funfacts: [
                "Bisa terinspirasi hanya dari cahaya senja atau bau hujan.",
                "Punya tab YouTube yang isinya: teori relativitas, cara membuat lilin, dan bahasa Latin.",
                "Wallpaper HP-nya bisa gambar lukisan surealis.",
                "Suka tiba-tiba nulis quote atau puisi di notes.",
                "Punya lebih banyak ide proyek daripada yang sempat dikerjakan.",
                "Bisa debat soal arti hidup hanya karena lihat iklan minuman."
            ]
        },
        conscientiousness: {
            ...
            keyCharacteristics: ["Disiplin", "teliti", "bertanggung", "fokus", "tekun", "terstruktur"],
            strength: [
                "Bisa diandalkan",
                "Goal-oriented",
                "Sabar",
            ...
            weakness: [
                ...
                "Takut gagal",
                "Terlalu serius",
                "Sulit beradaptasi spontan",
                "Bisa burnout"
            ],
            funfacts: [
                "Lebih bahagia kalau to-do list hari ini semua dicentang.",
                "Punya spreadsheet pribadi untuk budget, waktu, dan bahkan jam tidur.",
                "Sering nyusun ulang rak baju karena kurang simetris.",
                "Bangga kalau jadi orang pertama yang datang ke meeting.",
                "Punya alarm berlapis, 10 menit sekali.",
                "Istirahat = ngecek ulang rencana minggu depan."
            ]
        },
        extraversion: {
            name: "Extraversion",
            ...
            keyCharacteristics: ["Ceria", "energik", "percaya diri", "sosial", "spontan", "vokal"],
            strength: [
            ...
            funfacts: [
                "Bisa ngobrol dengan supir ojek online sepanjang jalan.",
                "Story IG-nya update tiap jam.",
                "Senyum ke kamera = refleks.",
                "Bisa mulai obrolan dengan siapa pun di lift.",
                "Paling semangat pas disuruh jadi volunteer dadakan.",
                "Kalau grup chat sepi, dia kirim meme."
            ]
        },
        agreeableness: {
            name: "Agreeableness",
            ...
            keyCharacteristics: ["Ramah", "pengertian", "lembut", "toleran", "suportif", "sabar"],
            strength: [
                "Empati tinggi",
                "Pemaaf",
                "Anti-konflik",
            ...
            weakness: [
                ...
                "Rentan dimanfaatkan",
                "Kurang tegas",
                "Cemas saat tidak disukai",
                "Sulit menyuarakan diri"
            ],
            funfacts: [
                "Sering bilang \"nggak apa-apa kok\" meski hatinya luka.",
                "Paling cepat kasih emoji ❤️ di chat.",
                "Di grup, selalu cek apakah semua sudah makan.",
                "Suka bantu temen move on walau dia sendiri belum.",
                "Lebih stres ngelihat orang lain marah daripada dimarahin langsung.",
                "Bisa ngasih pelukan virtual dengan kata-kata."
            ]
        },
        neuroticism: {
            name: "Neuroticism",
            ...
            keyCharacteristics: ["Sensitif", "reflektif", "cemas", "mudah tertekan", "emosional", "overthinker"],
            strength: [
                "Empati tajam",
                "Sadar diri",
                "Emosional artistik",
                "Punya kedalaman batin",
            ...
            funfacts: [
                ...
                "Denger lagu sedih = healing, bukan malah sedih.",
                "Bisa inget kalimat yang menyakitkan... dari 5 tahun lalu.",
                "Overanalyze ekspresi teman habis meeting.",
                "Nonton film bisa nangis, bahkan kalau karakternya robot.",
